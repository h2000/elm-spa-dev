					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								function () {
								var _v3 = config.routing.afterNavigate;
								if (_v3.$ === 'Just') {
									var toMsg = _v3.a;
									return A2(
										$elm$core$Basics$composeR,
										...
										toMsg(
											{
												_new: config.routing.fromUrl(url),
...
var $author$project$Ports$log = function (message) {
	return $author$project$Ports$outgoing(
		{
			action: 'LOG',
			data: $elm$json$Json$Encode$string(message)
		});
};
...
var $author$project$Generated$Pages$Docs_Folder_Msg = function (a) {
	return {$: 'Docs_Folder_Msg', a: a};
};
var $author$project$Generated$Pages$GuideModel = function (a) {
	return {$: 'GuideModel', a: a};
};
var $author$project$Generated$Pages$GuideMsg = function (a) {
	return {$: 'GuideMsg', a: a};
};
...
var $author$project$Generated$Docs$Pages$DynamicModel = function (a) {
...
var $ryannhg$elm_spa$Spa$Page$tuple = F3(
...
var $ryannhg$elm_spa$Spa$Page$element = function (page) {
			...
			return {
				...
				init: F2(
					function (pageParams, context) {
						return A3(
							$ryannhg$elm_spa$Spa$Page$tuple,
							toModel,
							toMsg,
...
var $author$project$Pages$Docs$Dynamic$Dynamic$FetchedContent = function (a) {
...
var $author$project$Pages$Docs$Dynamic$Dynamic$init = function (_v0) {
	...
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				expect: $elm$http$Http$expectString($author$project$Pages$Docs$Dynamic$Dynamic$FetchedContent),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('overview', '/docs/elm-spa'),
							_Utils_Tuple2('elm-spa init', '/docs/elm-spa/init'),
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('sandbox', '/docs/pages/sandbox'),
							_Utils_Tuple2('element', '/docs/pages/element'),
							_Utils_Tuple2('component', '/docs/pages/component')
						]))
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{bottom: 128, left: 16, right: 16, top: 40})
			]),
		_List_fromArray(
			[
				A2(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$map,
						function (p) {
							return p + (' ' + ($elm$core$String$fromInt(duration) + 'ms ease-in-out'));
						},
						properties))));
	});
...
var $author$project$Ui$viewButton = function (_v0) {
	var label = _v0.a;
	var url = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$link,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Ui$colors.white),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Ui$colors.coral),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Ui$colors.coral),
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color($author$project$Ui$colors.coral),
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					$elm$core$List$isEmpty(options.buttons) ? _List_Nil : _List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
							...
							A2($elm$core$List$map, $author$project$Ui$viewButton, options.buttons))
						])))
			]));
};
var $author$project$Pages$Guide$view = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$centerX]),
	_List_fromArray(
		[
			$author$project$Ui$hero(
			{
				...
				description: 'A guide for elm spa!',
				title: 'Guide'
			})
		]));
var $author$project$Pages$Guide$page = $ryannhg$elm_spa$Spa$Page$static(
	{
		title: $elm$core$Basics$always('Guide'),
		view: $elm$core$Basics$always($author$project$Pages$Guide$view)
	});
...
var $author$project$Generated$Routes$routes = {
	docs_dynamic: function (param1) {
		return $author$project$Generated$Route$Docs_Folder(
			A2(
				$author$project$Generated$Docs$Route$Dynamic,
				param1,
				{param1: param1}));
	},
	...
	docs_top: $author$project$Generated$Route$Docs_Folder(
		$author$project$Generated$Docs$Route$Top(
			{})),
	guide: $author$project$Generated$Route$Guide(
		{}),
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$spacing(24),
				$mdgriffith$elm_ui$Element$paddingEach(
				{bottom: 0, left: 16, right: 16, top: 32}),
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$width(
				A2($mdgriffith$elm_ui$Element$maximum, 720, $mdgriffith$elm_ui$Element$fill))
			]),
		_List_fromArray(
			[
				...
				currentRoute,
				_Utils_Tuple2('elm-spa', $author$project$Generated$Routes$routes.top)),
				A2(
				$author$project$Layout$viewLink,
				currentRoute,
				_Utils_Tuple2('docs', $author$project$Generated$Routes$routes.docs_top)),
				A2(
				$author$project$Layout$viewLink,
				currentRoute,
			...
			[
				...
				_List_fromArray(
					[
						...
						{name: 'Source Sans Pro', url: 'https://fonts.googleapis.com/css?family=Source+Sans+Pro:300'})
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$Generated$Routes$parsers = _List_fromArray(
	[
		...
		A2(
		$elm$url$Url$Parser$map,
		$author$project$Generated$Routes$routes.docs_top,
		A2(
		...
		A2(
		$elm$url$Url$Parser$map,
		$author$project$Generated$Routes$routes.docs_dynamic,
		A2(
			$elm$url$Url$Parser$slash,
			$elm$url$Url$Parser$s('docs'),
...
var $ryannhg$elm_spa$Internals$Transition$None = {$: 'None'};
var $ryannhg$elm_spa$Internals$Transition$none = $ryannhg$elm_spa$Internals$Transition$None;
var $ryannhg$elm_spa$Spa$Transition$none = $ryannhg$elm_spa$Internals$Transition$none;
var $author$project$Transitions$transitions = {layout: $ryannhg$elm_spa$Spa$Transition$none, page: $ryannhg$elm_spa$Spa$Transition$none, pages: _List_Nil};
